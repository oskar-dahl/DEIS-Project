...
%correction on Value component and defaults to gamma=1. 
%
...
%difference with the above) and defaults to 1. 
%
...
PI=4*atan(1);
gam=1;  %default , originally it was 3.5
scl='sclon'; %default
...
hVec = quiver(0,0,0,0,'Visible','off','hittest','off','color','r');
